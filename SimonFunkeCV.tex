...
\begin{outerlist}
    \item[] \supervision{Workshop,}{FEniCS/dolfin-adjoint workshops: Simula (2014, 1 day), Zhejiang University (2014, 5 days), Simula (2016, 2 days), Suurph workshop, Simula (2016, 1 day), Technical University of Munich (2016, 5 days)}{2014 - today}
    \item[] \supervision{Lecture,}{INF3331/INF4331 Higher-level programming, University of Oslo, Norway}{2015 - today}
%    \item[] \supervision{\hspace{1.2cm}Invited lecture,}{Introduction to PDE-constrained optimisation, Zhejiang University, China (1 week)}{2014}
    \item[] \supervision{Teaching assistant}{several courses on computational science, programming and mathematics. Department of Earth Science and Engineering, Imperial College London, UK}{2010 - 2012}
\end{outerlist}
...
%\sectionheader{Hackathon winners}
%\begin{outerlist}
%\item[] Prizewinner of BigDataHackthon for developing a machine learning algorithm that predicts the influence of people, May 2013.
...
%\item[] Invited visit to OpenITP & Rio de Janeiro RightsCon with the goal to develop realtime censorship detection, May 2012.
%\item[] Winner of WaterHackathon London for developing a reporting platform for managing sanitation complaints in Tanzania, Africa, October 2011.
