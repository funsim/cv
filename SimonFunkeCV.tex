...
\address{DeepTech Consulting AS, Bølerlia 149, 0689 Oslo, Norway}{simon@deeptechconsulting.no}{+47 40 62 55 86}{\href{http://www.simonfunke.com}{simonfunke.com}}
...
\begin{outerlist}
\item[] \positionlocationdate{\hspace{-0.2cm}Founding Director}{DeepTechConsulting AS, Oslo, Norway}{2021 - today}
\item[] \positionlocationdate{\hspace{-0.2cm}CTO}{RedHotRails LLP, UK}{2011 - today}
\item[] \positionlocationdate{\hspace{-0.2cm}Research Director}{Simula Research Laboratory, Oslo, Norway}{2019 - 2021}
\item[] \positionlocationdate{\hspace{-0.2cm}Senior IT Consultant}{Simula Consulting, Oslo, Norway}{2019 - 2021}
%\item[] \positionlocationdate{\hspace{-0.2cm}Head of Department}{Simula Research Laboratory, Oslo, Norway}{2018 - 2019}
\item[] \positionlocationdate{\hspace{-0.2cm}Senior Research Scientist}{Simula Research Laboratory, Oslo, Norway}{2015 - 2020}
...
\begin{itemize}
\item {Transdisciplinary publication of the year by the Center for digital life Norway}, 2019\\
	For the paper "Toward Personalized Computer Simulation of Breast Cancer Treatment: A Multiscale Pharmacokinetic and Pharmacodynamic Model Informed by Multitype Patient Data".
...
\begin{itemize}
\item PI on NOK 0.3MNOK RCN Regional kvalifiseringsstøtte ``Tilbakemelding i salgssamtalen'', (\#321801), 2020--2021
\item PI on NOK 12MOK RCN Research project ``Data-driven models for physical simulations'', (\#303362), 2020--2023
...
\begin{outerlist}
\item[] \supervision{PostDocs:}{August Johannsson, Miro Kuchta}{}
\item[] \supervision{PhD students:}{Marius Causemann, Sebastian Mitusch, James Trotter (co-supervisor), Bastian Zapf (co-supervisor), J\/orgen Dokken, Dave Culley (co-supervisor)}{}
\end{outerlist}
...
\begin{outerlist}
\item[] \supervision{NORA.startup}{Panelist in webinar ``Funding opportunities for Startups and Startup-Researcher collaborations''}{2021}
\item[] \supervision{Board member}{Simula Research Laboratory}{2019-2020}
...
\item[] \supervision{\textbf{R\&D Advisor}}{IMERSO AS, Oslo, Norway}{2014 - today}
...
\begin{etaremune}
\setcounter{enumi}{24}
    \item \textit{Jørgen S. Dokken, Sebastian K. Mitusch, Simon W. Funke.} Automatic shape derivatives for transient PDEs in FEniCS and Firedrake, \textit{arXiv}, \href{https://arxiv.org/abs/2001.10058}, 2020.
    \item \textit{Lars Magnus Valnes, Sebastian K. Mitusch, Geir Ringstad, Per Kristian Eide, Simon W. Funke, Kent-Andre Mardal.} Apparent diffusion coefficient estimates based on 24 hours tracer movement support glymphatic transport in human cerebral cortex, \textit{Nature Scientific Reports}, \href{https://doi.org/10.1038/s41598-020-66042-5}, 2020.
  \item \textit{J. S. Dokken, A. Johansson, A. Massing, S. W. Funke.} 	A multimesh finite element method for the Navier–Stokes equations based on projection methods, \textit{Computer Methods in Applied Mechanics and Engineering}, \href{https://doi.org/10.1016/j.cma.2020.113129}, 2020.
\end{etaremune}
2019
\begin{etaremune}
\setcounter{enumi}{21}
...
\begin{outerlist}
    \item[2020-2024] Marius Causemann, \textit{Exploring physics-based, data-driven models and their potential in weather and climate forecasting}, Simula Research Laboratory
    \item[2018-2021] Sebastian Mitusch, \textit{}, Simula Research Laboratory
    \item[2016-2019] J\/orgen Dokken, \textit{PDE-constrained optimisation with dynamic domains}, Simula Research Laboratory
...
\begin{outerlist}
    \item[2020-2021] Bernhardt Lotsberg, \textit{}, Simula Research Laboratory
    \item[2019-2020] Marius Causemann, \textit{}, Simula Research Laboratory
    \item[2018-2018] Sebastian Mitusch, \textit{}, Simula Research Laboratory
