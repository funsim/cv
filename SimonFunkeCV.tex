...
\item[] \supervision{PhD students:}{J\/orgen Dokken (Simula), Dave Culley (Imperial College, co-superviser)}{}
\end{outerlist}
...
\begin{outerlist}
    ...
    \item[2013-2016] Dave Culley, \textit{The modelling and design optimisation of tidal stream turbine arrays}, Imperical College London
\end{outerlist}
